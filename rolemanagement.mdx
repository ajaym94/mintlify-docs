...
To create a new role, click on the `Add Role` button. You will be asked to enter the name of the role and a description. Once you have entered the details, click on the `Create` button to create the role. That's it.
